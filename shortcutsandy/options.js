...
(function() {
  var $, BookmarkOptionsView, BookmarksView, CommandOptionsView, CommandsView, Config, CtxMenuFolder, CtxMenuFolderSet, CtxMenuGetterView, CtxMenuManagerView, CtxMenuOptionsView, EditableBaseView, ExplorerBaseView, HeaderView, KeyConfig, KeyConfigSet, KeyConfigSetView, KeyConfigView, PopupBaseView, Router, WebFontConfig, andy, bmOpenMode, bookmarksView, catnames, commandOptionsView, commandsDisp, commandsView, ctxMenuManagerView, ctxMenuOptionsView, decodeKbdEvent, defaultSleep, endEdit, escape, gMaxItems, getUuid, headerView, keyCodes, keyConfigSetView, keys, lastFocused, loading, marginBottom, modeDisp, modifierInits, modifierKeys, resizeTimer, router, scHelp, scHelpSect, startEdit, tmplCtxMenus, transKbdEvent, windowOnResize, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  EditableBaseView = (function(_super) {
    ...
    EditableBaseView.prototype.onShowPopup = function(name, model) {
      if (!EditableBaseView.__super__.onShowPopup.call(this, name, model)) {
        return false;
      }
      startEdit();
      return true;
    ...
    EditableBaseView.prototype.onHidePopup = function() {
      if (this.$el.is(":visible")) {
        endEdit();
        return EditableBaseView.__super__.onHidePopup.call(this);
      }
    };
  ...
  CommandOptionsView = (function(_super) {
    ...
    CommandOptionsView.prototype.render = function() {
      ...
      this.onClickChkCoffee({
        currentTarget: this.$("input[value='coffee']")
      });
      return this.editer.setOption("readOnly", false);
    };
  ...
  BookmarksView = (function(_super) {
    ...
    BookmarksView.prototype.onClickBookmark = function(event) {
      this.hidePopup();
      this.trigger("showPopup", "bookmarkOptions", this.model.id, $(event.currentTarget).attr("data-id"));
      return false;
    };
  ...
  CtxMenuManagerView = (function(_super) {
    ...
    CtxMenuManagerView.prototype.onHidePopup = function() {
      if (this.$el.is(":visible")) {
        endEdit();
        return CtxMenuManagerView.__super__.onHidePopup.call(this);
      }
    };
  ...
  HeaderView = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.setScHelp(kbdtype);
      return this.$(".addKeyConfig,.ctxmgr,.kbdtype,.scHelp,.helpview,.header a").show();
    },
    ...
    setScHelp: function(kbdtype) {
      ...
      return this.$(".scHelp").text("Keyboard shortcuts").attr("href", this.scHelpUrl + lang);
    },
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    onKeydownOrigin: function(event) {
      var i, keyname, keynames, scCode, scanCode, _i, _ref5;
    ...
    setDesc: function() {
      var bookmark, command, commandDisp, content, content3row, desc, editOption, help, i, key, keycombo, lang, lines, mode, pause, sleep, tdDesc, test, _i, _j, _ref5, _ref6, _ref7;
      ...
      switch (mode) {
        ...
        case "disabled":
          ...
          if (help　 && help[lang]) {
            for (i = _j = 0, _ref7 = help[lang].length; 0 <= _ref7 ? _j < _ref7 : _j > _ref7; i = 0 <= _ref7 ? ++_j : --_j) {
  ...
  KeyConfigSetView = Backbone.View.extend({
    ...
    onShowPopup: function(name, id, model, options) {
  ...
  Router = Backbone.Router.extend({
    ...
    onNavigatePopup: function(name, id) {
      ...
      return this.navigate("popup/" + name + params, {
        trigger: true
      });
    }
  });
