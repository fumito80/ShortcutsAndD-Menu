...
(function() {
  var $, BookmarkOptionsView, BookmarksView, CommandOptionsView, CommandsView, Config, CtxMenuFolder, CtxMenuFolderSet, CtxMenuGetterView, CtxMenuManagerView, CtxMenuOptionsView, ExplorerBaseView, HeaderView, KeyConfig, KeyConfigSet, KeyConfigSetView, KeyConfigView, PopupBaseView, Router, WebFontConfig, andy, bmOpenMode, bookmarksView, catnames, commandOptionsView, commandsDisp, commandsView, ctxMenuManagerView, ctxMenuOptionsView, decodeKbdEvent, defaultSleep, endEdit, escape, gMaxItems, getUuid, headerView, keyCodes, keyConfigSetView, keys, lastFocused, loading, marginBottom, modeDisp, modifierInits, modifierKeys, resizeTimer, router, scHelp, scHelpSect, startEdit, tmplCtxMenus, transKbdEvent, windowOnResize, _ref, _ref1, _ref2, _ref3,
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    setDesc: function() {
      var bookmark, command, commandDisp, content, content3row, desc, editOption, help, i, key, keycombo, lang, lines, mode, pause, sleep, tdDesc, test, _i, _j, _ref4, _ref5, _ref6;
      ...
      switch (mode) {
        ...
        case "disabled":
          ...
          if (help　 && help[lang]) {
            for (i = _j = 0, _ref6 = help[lang].length; 0 <= _ref6 ? _j < _ref6 : _j > _ref6; i = 0 <= _ref6 ? ++_j : --_j) {
