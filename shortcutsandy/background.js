...
(function() {
  var analyzeScHelpPage, closeTabs, closeWindow, createCtxMenus, createNotification, defaultSleep, deleteHistory, dfdCommandQueue, execBatchMode, execCommand, execCtxMenu, execJS, execShortcut, flexkbd, gCurrentTabId, getActiveTab, getAllTabs, getAllTabs2, getWindowTabs, jsCtxData, jsTransCodes, jsUtilObj, modifierInits, notifIcons, notifications, openBookmark, optionsTabId, preOpenBookmark, registerCtxMenu, removeCookie, scHelp, scHelpPageUrl, scHelpSect, scrapeHelp, sendMessage, setConfigPlugin, showNotification, tabStateNotifier, transKbdEvent, userData,
  ...
  chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    ...
    dfdCommandQueue = dfdCommandQueue.then(function() {
      var commandId, dfd, e, findStr, findtab, params;
      dfd = $.Deferred();
      setTimeout((function() {
      ...
      try {
        switch (request.action) {
          ...
          case "openUrl":
            ...
            preOpenBookmark(null, params).done(function(tabId) {
  ...
  chrome.tabs.onActivated.addListener(function(activeInfo) {
    return chrome.tabs.get(activeInfo.tabId, function(tab) {
      if (tab.url.indexOf(chrome.extension.getURL("options.html")) === 0 && !/popup/.test(tab.url)) {
