...
(function() {
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    onKeydownOrigin: function(event) {
      var i, keyname, keynames, scCode, scanCode, _i, _ref1;
      if (keynames = keyIdentifiers[this.kbdtype][event.originalEvent.keyIdentifier]) {
        ...
        for (i = _i = 0, _ref1 = keys.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
    ...
    setDesc: function() {
      var bookmark, command, commandDisp, content, content3row, desc, editOption, help, i, key, keycombo, lang, lines, mode, pause, tdDesc, test, _i, _j, _ref1, _ref2;
      ...
      if (mode === "disabled") {
        this.$(".addKey,.copySC,.seprater.1st").remove();
      }
