...
(function() {
  var $, BookmarksView, CommandInputView, CommandsView, Config, HeaderView, KeyConfig, KeyConfigSet, KeyConfigSetView, KeyConfigView, PopupBaseView, WebFontConfig, catnames, commandsDisp, decodeKbdEvent, endEdit, escape, fk, keyCodes, keys, marginBottom, optionsDisp, resizeTimer, saveData, scHelp, scHelpSect, startEdit, windowOnResize, _ref, _ref1,
  ...
  CommandInputView = (function(_super) {
    ...
    CommandInputView.prototype.render = function() {
      ...
      commandOption = this.$(".commandOptions").empty();
      return commandsDisp[this.command.name][2].forEach(function(option) {
        option.checked = "";
    ...
    CommandInputView.prototype.onShowPopup = function(name, model, options) {
      this.command = options;
      if (!CommandInputView.__super__.onShowPopup.call(this, name, model)) {
        return;
      }
    ...
    CommandInputView.prototype.onSubmitForm = function() {
      ...
      if ((content = this.$(".content").val()) !== "") {
        options = {};
        $.each(this.$(".commandOptions input[type='checkbox']"), function(i, option) {
    ...
    CommandInputView.prototype.hidePopup = function() {
      endEdit();
    ...
    CommandsView.prototype.onSubmitForm = function() {
      ...
      if (command = this.$(".radioCommand:checked").val()) {
        if ((category = commandsDisp[command][0]) === "custom") {
          this.trigger("showPopup", "commandInput", this.model, {
            name: command,
            category: category
          });
          this.$el.hide();
  ...
  BookmarksView = (function(_super) {
    ...
    BookmarksView.prototype.onClickBookmark = function(event) {
      ...
      this.trigger("setBookmark", this.model.id, {
        title: target.text(),
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    onClickEditCustomIcon: function() {
      return this.trigger("showPopup", "commandInput", this.model, this.model.get("command"));
    },
    ...
    setDesc: function() {
      var command, commandDisp, content, content3row, desc, help, i, key, keycombo, lang, lines, mode, tdDesc, test, url, _i, _j, _ref2, _ref3;
