...
(function() {
  var $, BookmarkOptionsView, BookmarksView, CommandOptionsView, CommandsView, Config, HeaderView, KeyConfig, KeyConfigSet, KeyConfigSetView, KeyConfigView, PopupBaseView, WebFontConfig, bmOpenMode, bookmarksView, catnames, commandsDisp, commandsView, decodeKbdEvent, endEdit, escape, fk, keyCodes, keyConfigSetView, keys, marginBottom, modifierInits, modifierKeys, optionsDisp, resizeTimer, saveData, scHelp, scHelpSect, startEdit, transKbdEvent, windowOnResize, _ref,
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    setDesc: function() {
      ...
      if (editOption.iconName === "") {
        return tdDesc.find(".edit").remove();
      }
    },
  ...
  $(function() {
    var bookmarkOptionsView, commandOptionsView, headerView;
