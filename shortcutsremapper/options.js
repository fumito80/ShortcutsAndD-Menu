...
(function() {
  var $, BookmarkOptionsView, BookmarksView, CommandOptionsView, CommandsView, Config, CtxMenuOptionsView, HeaderView, KeyConfig, KeyConfigSet, KeyConfigSetView, KeyConfigView, PopupBaseView, WebFontConfig, bmOpenMode, bookmarksView, catnames, commandOptionsView, commandsDisp, commandsView, decodeKbdEvent, endEdit, escape, fk, gMaxItems, keyCodes, keyConfigSetView, keys, lastFocused, marginBottom, modeDisp, modifierInits, modifierKeys, resizeTimer, saveData, scHelp, scHelpSect, startEdit, transKbdEvent, windowOnResize, _ref, _ref1,
  ...
  CommandOptionsView = (function(_super) {
    ...
    CommandOptionsView.prototype.render = function() {
      ...
      if ((commandName = this.command.name) === "clearHistoryS") {
        content$.attr("rows", "1");
      } else {
      ...
      content$.val(this.command.content);
  ...
  BookmarkOptionsView = (function(_super) {
    ...
    BookmarkOptionsView.prototype.onSubmitForm = function() {
      ...
      this.model.set({
        "bookmark": _.extend(this.bookmark, options)
      }, {
        silent: true
  ...
  CtxMenuOptionsView = (function(_super) {
    ...
    CtxMenuOptionsView.prototype.render = function() {
      ...
      if (this.ctxMenu) {
        return this.$(".delete").removeClass("disabled").removeAttr("disabled");
      } else {
        return this.$(".delete").addClass("disabled").attr("disabled", "disabled");
      }
    };

    CtxMenuOptionsView.prototype.onShowPopup = function(name, model, options) {
      this.options = options;
      if (!CtxMenuOptionsView.__super__.onShowPopup.call(this, name, model)) {
        return;
      }
      return startEdit();
    };
    ...
    CtxMenuOptionsView.prototype.onClickSubmit = function(event) {
      var callback, caption, menutype, that, type;
      if ((caption = this.$(".caption").val()) !== "") {
  ...
  KeyConfigView = Backbone.View.extend({
    ...
    onChangeCtxmenu: function() {
      ...
      if (ctxMenu = this.model.get("ctxMenu")) {
        this.$("td.ctxmenu").html("<i class=\"icon-reorder\" title=\"Context menu for " + ctxMenu.contexts + "\"></i>");
  ...
  $(function() {
    var bookmarkOptionsView, ctxMenuOptionsView, headerView;
