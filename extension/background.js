...
(function() {
  var analyzeScHelpPage, flexkbd, forecast, optionsTabId, preSendKeyEvent, scHelp, scHelpPageUrl, sendKeyEventToDom, sendMessage, setConfigPlugin, xhr;
  ...
  analyzeScHelpPage = function(resp, lang) {
    ...
    return $.each(targets, function(i, elem) {
      ...
      return Array.prototype.forEach.call(elem.childNodes[1].getElementsByTagName("strong"), function(strong) {
        ...
        return scHelp[scKey][lang].push(content);
      });
    });
  };
